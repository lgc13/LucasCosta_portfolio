...
<!-- Screenshots -->
<img src="/java/ExpenseReimbursementsSystem/img/invalid_login.PNG" width= 60% length= 60%>
<img src="/java/ExpenseReimbursementsSystem/img/info_edit_employee.PNG" width= 60% length= 60%>
<img src="/java/ExpenseReimbursementsSystem/img/employee_create_manager.PNG" width= 60% length= 60%>
<img src="/java/ExpenseReimbursementsSystem/img/reimbursements_manager.PNG" width= 60% length= 60%>
<img src="/java/ExpenseReimbursementsSystem/img/reimbursements_request_employee.PNG" width= 60% length= 60%>
<img src="/java/ExpenseReimbursementsSystem/img/reimbursements_updated_manager.PNG" width= 60% length= 60%>
<img src="/java/ExpenseReimbursementsSystem/img/reimbursements_viewUpdated_employee.PNG" width= 60% length= 60%>
