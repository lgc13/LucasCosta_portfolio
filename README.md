...
<!-- Project section -->
<h2><a href="https://github.com/lgc13/LucasCosta_portfolio/tree/master/java/ExpenseReimbursementSystem">2- Expense Reimbursement System project</a></h2>
...
<!-- Screenshots -->
<img src="/java/ExpenseReimbursementSystem/img/invalid_login.PNG" width= 60% length= 60%>
<img src="/java/ExpenseReimbursementSystem/img/info_edit_employee.PNG" width= 60% length= 60%>
<img src="/java/ExpenseReimbursementSystem/img/employee_create_manager.PNG" width= 60% length= 60%>
<img src="/java/ExpenseReimbursementSystem/img/reimbursements_manager.PNG" width= 60% length= 60%>
<img src="/java/ExpenseReimbursementSystem/img/reimbursements_request_employee.PNG" width= 60% length= 60%>
<img src="/java/ExpenseReimbursementSystem/img/reimbursements_updated_manager.PNG" width= 60% length= 60%>
<img src="/java/ExpenseReimbursementSystem/img/reimbursements_viewUpdated_employee.PNG" width= 60% length= 60%>
