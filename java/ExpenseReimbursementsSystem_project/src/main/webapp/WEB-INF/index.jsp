...
<title>Project 1</title><!-- tab title  -->
	...
	<body>
		...
		<div class="well">  <!-- beginning of actual website display -->
			<h2>You can view any of your personal info in the my information tab</h2>	
			
			<h2>If you need to submit a reimbursement request, go to the reimbursements tab</h2>    
