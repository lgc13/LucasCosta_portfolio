...
$sto_url_v = $_POST['URL'];
$sto_std_sales_v = $_POST['stdsales'];
...
$query =
"INSERT INTO store
(sto_name, sto_street, sto_city, sto_state, sto_zip, sto_phone, sto_email, sto_url, sto_std_sales, sto_notes)
 VALUES
(:sto_name_p, :sto_street_p, :sto_city_p, :sto_state_p, :sto_zip_p, :sto_phone_p, :sto_email_p, :sto_url_p, :sto_std_sales_p, :sto_notes_p)";
