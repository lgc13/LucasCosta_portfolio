		...
		<div class="container">
			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="../customerform.jsp?assign_num=a4">Add a Customer</a></li>
					<%-- <li><a href="../customerform.jsp?assign_num=a5">A5</a></li> --%>
					<li><a href="../project1/index.jsp">Add - Client Side Validation</a></li>
					<li><a href="../customerform.jsp?assign_num=p2">Add - Server Side Validation</a></li>
					<li><a href="../customerAdmin">Display Customers</a></li>
