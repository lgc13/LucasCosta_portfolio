			...
			fields: {
				...
				lname: {
					...
					balance: {
							validators: {
									notEmpty: {
											message: 'Balance sales required'
									},
									stringLength: {
											min: 1,
											max: 11,
											message: 'Balance can be no more than 10 digits'
									},
									regexp: {
										//street: only letters, numbers, comma, space character, and period
										regexp: /^[0-9\.]+$/,
					...
					totalsales: {
							validators: {
									...
									stringLength: {
											min: 1,
											max: 11,
											message: 'Total sales can be no more than 10 digits'
									},
									regexp: {
										//street: only letters, numbers, comma, space character, and period
										regexp: /^[0-9\.]+$/,
