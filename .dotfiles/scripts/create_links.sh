...
ln -sv ~/Desktop/LucasProjects/LucasCosta_portfolio/.dotfiles/atom-package.list ~/.atom/package.list
ln -sv ~/Desktop/LucasProjects/LucasCosta_portfolio/.dotfiles/atom-config.cson ~/.atom/config.cson
